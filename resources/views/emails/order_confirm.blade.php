                                    ...
                                    <tr>
                                       <td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0px 20px 15px;margin:0;line-height:18px;text-align:center">
                                        ...
                                        @endif
                                          ...
                                          <br>
                                          <p style="margin:0px 10% 0px 10%;text-align:center;font-family:Verdana,Arial;font-weight:normal">Your order @if(isset($data['order_id'])) {{$data['order_id']}} @endif is confirmed. We're glad to have you as part of our journey as we celebrate India’s rich artisanal flair. Your purchase has made a 
                                    ...
                                    <tr>
                                       <td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:5px 15px;margin:0;text-align:center">
                                          ...
                                          <p style="font-family:Verdana,Arial;font-weight:normal;font-size:11px;margin:1em 0 0px">
                                          	@if(isset($data['time'])) 
                                          	{{date('M d, Y h:i:s a',strtotime($data['time']))}}
                                          	@endif
                                          </p>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:10px 15px 0;margin:0;padding-top:10px;text-align:center">
                                        ...
                                        @if(isset($data['name']))
                                           {{$data['name']}} 
                                        @endif
                                        <br>  {{$data['address']->address1}} {{$data['address']->address2}}
                                        <br>    {{$data['address']->city}},  {{$data['address']->state}}, {{$data['address']->zip_code}}
                                        <br> {{$data['address']->country}}
                                        <br> T: {{$data['address']->phone}} 
                                    </span>
                                    @endif
                                </p>
...
<div style="border:1px solid #B52A6B;border-right:none">
	<img src="{{url('public')}}/{{$pr_img}}" style="max-width:91px;display:block;border:0px solid #B52A6B" class="CToWUd"></div>
</td>
...
<p style="text-transform:uppercase;font-family:Verdana,Arial;font-weight:normal;margin:0 0 14px 0;color:#333;font-style:normal;line-height:1.4;font-size:14px">{{$crt->product_name}}</p>
...
<td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0">Qty: {{$crt->qty}}</td>
<td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0">       
<span style="font-family:&quot;Helvetica Neue&quot;,Verdana,Arial,sans-serif"> Rs {{$crt->price}} x {{$crt->qty}} = Rs {{$sub_total}}</span>
</td>
</tr>
</tbody>
</table>
                                    ...
                                    <tr>
                                       <td style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0">
                                          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;padding:0;margin: 17px auto;">
                                             <tbody>
                                                <tr>
                                                   <td valign="center" style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;text-align:center">                                                      <a href="https://www.facebook.com/Priya-Chaudhary-Label-491436704638885/" style="color:#333333!important" rel="noreferrer noopener" target="_blank" data-saferedirecturl="#">                                                         <img alt="Facebook" src="{{url('public/front/assets/img/facebook.png')}}" style="width:100%" class="CToWUd"></a>                                                   </td>
                                                   <td valign="center" style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;text-align:center">                                 
                                                      <a href="#" style="color:#333333!important" rel="noreferrer noopener" target="_blank" data-saferedirecturl="#"><img alt="Pintrest" src="{{url('public/front/assets/img/footer02.png')}}" style="width:100%" class="CToWUd"></a>                                                   
                                                   </td>
                                                   <td valign="center" style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;text-align:center"> 
                                                      <a href="https://instagram.com/priyachaudharylabel?igshid=vkm07ds3t41y" style="color:#333333!important" rel="noreferrer noopener" target="_blank" data-saferedirecturl="#"><img alt="instagram" src="{{url('public/front/assets/img/footer03.png')}}" style="width:100%" class="CToWUd"></a>                                                   
                                                   </td>
                                                   <td valign="center" style="font-family:Verdana,Arial;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;text-align:center">                                                      <a href="#" style="color:#333333!important" rel="noreferrer noopener" target="_blank" data-saferedirecturl="#"><img alt="twitter" src="{{url('public/front/assets/img/footer04.png')}}" style="width:100%" class="CToWUd"></a>                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </td>
