         ...
         <div class="col-lg-4 col-md-4 col-sm-4 col-6">
            <a href="{{url($cate->slug)}}">
               <div class="single_banner">
                  <img src="{{url('public/'.$cate->image)}}" alt="{{$cate->alt}}">
                  <div class="single_banner_info">
            <a href="{{url($cate->slug)}}" class="btn btn-block btn-sucess rounded-0 single_bn_link">{{$cate->name}}</a>
            </div>
            </div>
            </a>
         </div>
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="single_banner">
               ...
               <img src="{{ url('public') }}/{{ $item->image }}" alt="shop_banner_img1"/>
               </a>
               <div class="single_banner_info">
                  <h3 class="single_bn_title">{{ $item->name }}</h3>
                  <a href="{{ url('') }}/{{ $item->slug }}" class="btn btn-sucess rounded-0 single_bn_link">Shop Now</a>
               </div>
            </div>
         </div>
         @endforeach
                  ...
                  <div class="product product_box">
                     ...
                     <div class="product_info">
                        ...
                        <div class="product_price">
                           @if ($p_product->is_sale==1)
                           <span class="price">₹{{ $p_product->sale_price }}</span>
                           <del>₹{{ $p_product->price }}</del>
                           <div class="on_sale">
                              <span>{{ number_format(100-($p_product->sale_price/$p_product->price)*100,2) }}% Off</span>
                           </div>
                           @else
                           <span class="price">₹{{ $p_product->price }}</span>
                           @endif
                        </div>
                     </div>
                  </div>
      ...
      <div class="row justify-content-center">
         <div class="col-md-12">
            <video class="video" width="100%" playsinline="playsinline" muted="muted" preload="yes" autoplay="autoplay" loop="loop" data-setup='{"autoplay":"any"}'>
               <source src="{{ url('public/frontend/images/video/ikshita.mp4') }}" type="video/mp4">
            </video>
         </div>
      </div>
   </div>
...
<div class="section bg_light_blue2 cst-1 mt-40" style="background: url({{ url('public/frontend/images/bg/1.jpg') }});">
         ...
         <div class="col-md-6">
            <div class="trand_banner_text text-center ">
               <div class="heading_s1 mb-3">
                  <div class="icon">
                     <img src="{{ url('public/frontend/images/icon/french-style-model.png') }}" alt="Indian designs">
                  </div>
               ...
               <a href="{{ url('shop') }}" class="btn btn-fill-out rounded-0">Shop Now</a>
            </div>
            <div class="medium_divider clearfix"></div>
         </div>
         <div class="col-md-6 ptl-0">
            <div class="text-center trading_img-1">
               <img src="{{ url('public/frontend/images/authentic-indian-designs.webp') }}" alt="Authentic Indian designs"/>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      ...
      <div class="row align-items-center justify-content-center mx-800">
         <div class="col-sm-4 text-center">
            ...
            <img src="{{ url('public/frontend/images/brand/1.jpg') }}" alt="brand">
            </a>
         </div>
         <div class="col-sm-4 text-center">
            <a href="https://www.ogaanmarket.com/designer/ikshita-choudhary" target="_blank">
            <img src="{{ url('public/frontend/images/brand/2.jpg') }}" alt="brand">
            </a>
         </div>
         <div class="col-sm-4 text-center">
            <a href="https://www.jaypore.com/search?q=ikshita%20choudhary&orderBy=-created_at" target="_blank">
            <img src="{{ url('public/frontend/images/brand/3.jpg') }}" alt="brand">
            </a>
         </div>
      </div>
   </div>
         ...
         <div class="col-md-6">
            <div class="heading_s1 text-center">
               ...
               <div>
                  ...
                  <span class="sc_icon"><i><img src="{{ url('public/frontend/images/icon/ins.png') }}" alt="insta_img"></i></span> Instagram</a> <span>|</span>
                  <a class="btn  rounded-5" href="https://www.facebook.com/ikshitachoudhary" target="_blank">
                  <span class="sc_icon"><i><img src="{{ url('public/frontend/images/icon/fb.png') }}" alt="insta_img"></i></span> Facebook</a>
               </div>
         ...
         <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="widget">
               <ul class="widget_instafeed instafeed_col4">
                  <li><a href="https://www.instagram.com/ikshitachoudhary" target="_blank"><img src="{{ url('public/frontend/images/instafeed/1.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                  <li><a href="https://www.instagram.com/ikshitachoudhary" target="_blank"><img src="{{ url('public/frontend/images/instafeed/2.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                  <li><a href="https://www.facebook.com/ikshitachoudhary" target="_blank"><img src="{{ url('public/frontend/images/instafeed/3.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-facebook"></i></span></a></li>
                  <li><a href="https://www.facebook.com/ikshitachoudhary" target="_blank"><img src="{{ url('public/frontend/images/instafeed/4.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-facebook"></i></span></a></li>
               </ul>
            </div>
         </div>
      </div>
