                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="product-quantity" data-title="Quantity">
                              <form id="cart_form" action="{{ route("cart.update",$item->id) }}" method="POST">
                              @csrf
                              @method('PUT')                                    
                              <div class="quantity">
                                 <input type="button" id="cart_minus" value="-" class="minus">
                                 <input type="number" name="quantity" value="{{ $item->quantity }}" readonly="readonly"  title="Qty" class="qty" min="1" size="4">
