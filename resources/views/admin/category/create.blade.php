                        ...
                        <div class="col-md-12">
                           <div class="card-body">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name" class="form-control" id="name" placeholder="Enter Category" value="{{old('name')}}" required="">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="alt" value="{{old('alt')}}" class="form-control" id="alt" placeholder="Image Alt Tag" required>
                              </div>
                              <div class="form-group">
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>{{$cate['name']}}</td>
                                 <td>
                                    <img src="{{ url('public') }}/{{ $cate['image'] }}" alt="" style="height: 70px;">
                                 </td>
                                 <td>
                                    <div class="btn-group btn-group-sm">
                                       <a href="{{url('admin/product/category/')}}/{{$cate['id']}}/edit" class="btn btn-info"><i class="fas fa-eye"></i></a>
