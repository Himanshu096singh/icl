  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Product Category Image Edit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card">
<div class="card-header"><h3 class="card-title">Edit Category Images</h3></div>
<form action="{{url('admin/product/update_images_cate')}}" method="post" enctype="multipart/form-data">
@csrf
