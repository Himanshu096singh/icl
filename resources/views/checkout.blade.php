        	...
        	<div class="col-md-6">
            	<div class="heading_s1">
                    ...
                    <div class="form-group">
                        <input type="text" required class="form-control" name="name" placeholder="Full name *" value="{{ $user->name }}">
                    </div>
                    <div class="form-group">
                        <input type="text" required class="form-control" name="phone" placeholder="Phone *" value="{{ $user->phone }}">
                    </div>
                    <div class="form-group">
                        <input class="form-control" required type="text" name="email" placeholder="Email" value="{{ $user->email }}" readonly>
                    </div>                      
                    <div class="form-group">
