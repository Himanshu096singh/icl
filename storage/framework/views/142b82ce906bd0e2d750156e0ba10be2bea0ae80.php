...
<?php $__env->startSection('title', 'Shipping Charges'); ?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo e(url('admin/shipping/create')); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add shipping</a>
              </div>
...
?>
  ...
  <td>
     <div class="btn btn-group">
      <a href="<?php echo e(url('admin/shipping')); ?>/<?php echo e($item->id); ?>/edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/admin/shipping/list.blade.php ENDPATH**/ ?>