         ...
         <tr>
            <td style="padding: 20px 0 30px 0;">
               <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;">
                  <tr>
                     <td align="center" bgcolor="#70bbd9" style="padding: 20px 0 30px 0;font-family: Arial, sans-serif;color:#fff;">
                        ...
                        <span style="font-size: 20pt;">Shopunity</span>
                     </td>
                  </tr>
                  <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                           <tr>
                              <td style="color: #153643; font-family: Arial, sans-serif;">
                                 <h1 style="font-size: 24px; margin: 0;text-align: center;">Thanks for Order</h1>
                                 <?php echo e($details); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/emails/order_invoice.blade.php ENDPATH**/ ?>