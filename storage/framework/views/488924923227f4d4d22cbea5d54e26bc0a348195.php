   ...
   <body>
                  ...
                  <div class="col-md-4">
                     <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <ul class="contact_detail text-center text-lg-left">
                           <li><a href="tel:<?php echo e($info->store_phone); ?>"><i
                              class="ti-mobile"></i><span><?php echo e($info->store_phone); ?></span></a></li>
                           <li><a href="mailto:<?php echo e($info->store_email); ?>"><i
                              class="ti-email"></i><span><?php echo e($info->store_email); ?></span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-md-4">
         ...
         <div class="middle-header dark_skin">
            <div class="container">
               <div class="nav_block">
                  ...
                  <img class="logo_light" src="<?php echo e(url('public/frontend/images/logo_light.png')); ?>"
                     alt="<?php echo e($info->alt); ?>" />
                  <img class="logo_dark" src="<?php echo e(url('public/frontend/images/logo_dark.png')); ?>"
                     alt="<?php echo e($info->alt); ?>" />
                  </a>
               </div>
            </div>
               ...
               <nav class="navbar navbar-expand-lg">
                     ...
                     <ul class="navbar-nav drop-menu">
                        ...
                        <div class="dropdown-main ">
                           <div class="dropdown-menu">
                              <?php $__currentLoopData = $navcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($cat->products_count > 0): ?>
                                    <div clas="top-wear">
                                       <div class="dropdown-head">
                                          <h3 class="top-wear-heading"><a href="<?php echo e(url($cat->slug)); ?>"><?php echo e(strtoupper($cat->name)); ?></a></h3>
                                       </div>
                                       <ul class="dropDown-ul">
                                          <?php $__currentLoopData = $cat->subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <?php if($subcat->products_count > 0): ?>
                                                <a href="<?php echo e(url($cat->slug.'/'.$subcat->slug)); ?>">
                                                   <li class="drop-down-li"><?php echo e($subcat->name); ?></li>
                                                </a>
                                             <?php endif; ?>
                        ...
                        <li class="nav-item dropdown-smd">
                           ...
                           <div class="collapse" id="submenu1" aria-expanded="false">
                              <ul class="flex-column pl-2 nav">
                                 <?php $__currentLoopData = $navcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($cat->products_count > 0): ?>
                                 <li class="nav-item">
                                    <a class="nav-link  text-truncate collapsed py-1 catg-flex-sm-inner"
                                       href="<?php echo e(url($cat->slug)); ?>" data-toggle="collapse"
                                       data-target="#submenu1sub<?php echo e($index); ?>">
                                    <span><?php echo e(strtoupper($cat->name)); ?></span>
                                    <i class="ion-ios-arrow-down"></i>
                                    </a>
                                    <div class="collapse" id="submenu1sub<?php echo e($index); ?>" aria-expanded="false">
                                       <ul class="flex-column nav pl-4">
                                          <?php $__currentLoopData = $cat->subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <?php if($subcat->products_count > 0): ?>
                                             <li class="nav-item">
                                                <a class="nav-link p-1 text-truncate" href="<?php echo e(url($cat->slug.'/'.$subcat->slug)); ?>">
                  ...
                  <ul class="navbar-nav attr-nav align-items-center">
                     ...
                     <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                           <ul>
                              <li><a class="dropdown-item nav-link nav_item" href="<?php echo e(url('customer')); ?>">My
                                 Account</a>
                              </li>
                              <li><a class="dropdown-item nav-link nav_item"
                                 href="<?php echo e(url('customer/orders')); ?>">My Order</a></li>
                              <li><a class="dropdown-item nav-link nav_item"
                                 href="<?php echo e(url('customer/address')); ?>">My Address</a></li>
                              <li><a class="dropdown-item nav-link nav_item"
                                 href="<?php echo e(url('logout')); ?>">Logout</a></li>
                           </ul>
                        </div>
                     </li>
                     <?php else: ?>
                     ...
                     <?php endif; ?>
                     <li>
                        <a class="nav-link nav_item" href="<?php echo e(url('cart')); ?>"><i
                           class="linearicons-cart"></i><span
                           class="cart_count"><?php echo e(\Cart::getTotalQuantity()); ?></span></a>
                     </li>
                  </ul>
               </nav>
            </div>
      ...
      <footer class="footer_dark" style="background: url(<?php echo e(url('public/frontend/images/footer-bg.png')); ?>);">
         <div class="bg-foot">
                        ...
                        <div class="widget">
                           <div class="footer_logo">
                              <a href="<?php echo e(url('/')); ?>"><img
                                 src="<?php echo e(url('public/frontend/images/logo_dark.png')); ?>"
                                 alt="logo" /></a>
                           </div>
            ...
            <?php if(Request::url() === 'https://ikshitachoudhary.com' ||
            ...
            <div class="bottom_footer border-top-tran">
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-lg-12">
                        <p class="text-center">© <?php echo e(date('Y')); ?> All Rights Reserved By Ikshitachoudhary.com |
...
<?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/layouts/front.blade.php ENDPATH**/ ?>