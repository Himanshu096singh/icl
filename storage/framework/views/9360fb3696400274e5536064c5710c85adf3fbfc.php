                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="product-quantity" data-title="Quantity">
                              <form id="cart_form" action="<?php echo e(route("cart.update",$item->id)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('PUT'); ?>                                    
                              <div class="quantity">
                                 <input type="button" id="cart_minus" value="-" class="minus">
                                 <input type="number" name="quantity" value="<?php echo e($item->quantity); ?>" readonly="readonly"  title="Qty" class="qty" min="1" size="4">
                                 <input type="button" id="cart_plus" value="+" class="plus" >
                              </div>
                              </form>
                           </td>
                              ...
                              <div class="row no-gutters align-items-right justify-content-right">
                                 <div class="col-lg-4 col-md-6 mb-3 mb-md-0 float-right">
                                    <div class="coupon field_form input-group">
                                       <form action="<?php echo e(url('cart/discount')); ?>" method="POST">
                                          <?php echo csrf_field(); ?>  
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/cart.blade.php ENDPATH**/ ?>