                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody>
                              <?php
                                 $i=1;
                              ?>
                              <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php
                                 $active="";
                              ...
                              <tr>
                                 ...
                                 <td><img src="<?php echo e(url('public/'.$list->image)); ?>" width="100px" ></td>
                                
                                 <td>
                                    <div class="btn-group btn-group-sm">
                                       <a href="<?php echo e(url('admin/product/brand/')); ?>/<?php echo e($list['id']); ?>/edit" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                       <form action="<?php echo e(route('brand.destroy',$list['id'])); ?>" method="POST">
                                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/admin/brand/create.blade.php ENDPATH**/ ?>