...
unset($__errorArgs, $__bag); ?> 
                        ...
                        <div class="form-note text-center">Don't Have an Account? <a href="<?php echo e(url('register')); ?>">Sign up now</a></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/auth/login.blade.php ENDPATH**/ ?>