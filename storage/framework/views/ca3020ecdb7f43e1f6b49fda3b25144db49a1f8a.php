...
<div class="section">
	<div class="container">        
        ...
        <form action="<?php echo e(url('place_order')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        <div class="row">
        	<div class="col-md-6">
            	<div class="heading_s1">
                    ...
                    <div class="form-group">
                        <input type="text" required class="form-control" name="name" placeholder="Full name *" value="<?php echo e($user->name); ?>">
                    </div>
                    <div class="form-group">
                        <input type="text" required class="form-control" name="phone" placeholder="Phone *" value="<?php echo e($user->phone); ?>">
                    </div>
                    <div class="form-group">
                        <input class="form-control" required type="text" name="email" placeholder="Email" value="<?php echo e($user->email); ?>" readonly>
                    </div>                      
                    <div class="form-group">
                        <input type="hidden" name="country" id="countryId" value="IN"/>                           
                        <select class="states order-alpha form-control form-control--sm" name="state" id="stateId" required>
                            <option value="">Select State</option>
                        </select>
                    </div>  
                    <div class="form-group">
                        <select class="cities order-alpha form-control form-control--sm" name="city" id="cityId" required>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\icl\resources\views/checkout.blade.php ENDPATH**/ ?>